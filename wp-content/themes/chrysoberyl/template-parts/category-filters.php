...
<section class="mb-8 relative" aria-label="<?php esc_attr_e( 'Category filters', 'chrysoberyl' ); ?>">
    ...
    <div class="md:hidden">
        ...
        <div id="category-dropdown"
            ...
            <a href="<?php echo esc_url( $home_url ); ?>"
                class="chrysoberyl-category-link block px-5 py-3 hover:bg-google-gray-50 transition-colors border-b border-gray-100 flex items-center justify-between <?php echo ! $is_category ? 'bg-google-gray-50' : ''; ?>"
    ...
    <div class="hidden md:flex items-center gap-3 overflow-x-auto pb-4 no-scrollbar">
        <a href="<?php echo esc_url( $home_url ); ?>"
            class="px-5 py-2.5 rounded-pill font-medium text-sm whitespace-nowrap transition-colors <?php echo ! $is_category ? 'bg-google-gray-100 text-google-gray hover:bg-google-gray-200' : 'border border-gray-200 text-google-gray-500 hover:bg-google-gray-50 hover:border-gray-300'; ?>">
