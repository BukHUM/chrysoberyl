...
<div class="mt-16 pt-8 border-t border-gray-200" aria-label="<?php esc_attr_e( 'เกี่ยวกับผู้เขียน', 'chrysoberyl' ); ?>">
    <div class="flex flex-col sm:flex-row items-start gap-6 bg-google-gray-50 rounded-card p-6">
        ...
        <div class="min-w-0 flex-1">
            ...
            <div class="flex gap-3">
                <a href="<?php echo esc_url( $author_posts_url ); ?>" class="text-google-gray-500 hover:text-google-blue transition-colors" aria-label="<?php esc_attr_e( 'บทความทั้งหมดโดยผู้เขียน', 'chrysoberyl' ); ?>">
                ...
                <?php if ( ! empty( $author_url ) ) : ?>
                    <a href="<?php echo esc_url( $author_url ); ?>" class="text-google-gray-500 hover:text-google-blue transition-colors" aria-label="<?php esc_attr_e( 'เว็บไซต์ผู้เขียน', 'chrysoberyl' ); ?>" rel="noopener noreferrer" target="_blank">
