...
if ( ! function_exists( 'chrysoberyl_pagination' ) ) {
    function chrysoberyl_pagination() {
        ...
        echo '<nav class="pagination flex justify-center items-center gap-2 mt-10" aria-label="' . esc_attr__( 'Pagination', 'chrysoberyl' ) . '">';
...
if ( function_exists( 'the_posts_pagination' ) ) {
    the_posts_pagination( array(
        'mid_size'  => 2,
        'prev_text' => '<i class="fas fa-chevron-left"></i> ' . __( 'ก่อนหน้า', 'chrysoberyl' ),
        'next_text' => __( 'ถัดไป', 'chrysoberyl' ) . ' <i class="fas fa-chevron-right"></i>',
    ) );
} else {
